...
# =======> How to Play Manlysweeper <=======
1. Left click on any tile to begin. The first click of any game will ALWAYS be safe unless the setting "Safe Start" is turned off.
2. Number tiles indicate how many mines are in the neighboring 8 tiles.
