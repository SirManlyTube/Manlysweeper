...
namespace detail
{
	...
	union float_t<float>
	{
		...
		GLM_CONSTEXPR bool negative() const { return j < 0; }
		GLM_CONSTEXPR int_type mantissa() const { return j & ((1 << 23) - 1); }
		GLM_CONSTEXPR int_type exponent() const { return (j >> 23) & ((1 << 8) - 1); }
